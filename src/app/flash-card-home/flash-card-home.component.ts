...
@Component({
  selector: 'app-flash-card-home',
  imports: [CommonModule, FlashCardComponent],
  templateUrl: './flash-card-home.component.html',
  styleUrl: './flash-card-home.component.css'
})
export class FlashCardHomeComponent {
  ...
  availableCSVFiles = [
    ...
    'ADVANCED-JAVA-CLASS-DESIGN-120Q-D-1.csv',
    'ARRAYS-AND-COLLECTIONS-181Q-C-1.csv',
    'ARRAYS-LISTS-AND-COLLECTIONS-120Q-D-1.csv',
    'AUTOBOXING-AND-AUTOCASTING-120Q-D-1.csv',
    'BUILDING-DATABASE-APPLICATIONS-WITH-JDBC-120Q-D-1.csv',
    'CONTROLLING-PROGRAM-FLOW-297Q-C-1.csv',
    'DATE-TIME-API-353Q-A-1.csv',
    'GENERICS-AND-COLLECTIONS-120Q-D-1.csv',
    'HANDLING-DATE-TIME-120Q-D-1.csv',
    'HANDLING-DATE-TIME-TEXT-NUMERIC-BOOLEAN-124Q-C-1.csv',
    'HANDLING-EXCEPTIONS-120Q-D-1.csv',
    'HANDLING-EXCEPTIONS-212Q-C-1.csv',
    'HANDLING-TEXT-120Q-D-1.csv',
    'JAVA-CONCURRENCY-120Q-D-1.csv',
    'JAVA-DATE-TIME-API-120Q-D-1.csv',
    'JAVA-IO-AND-FILE-IO-120Q-D-1.csv',
    ...
    'JAVA-OPERATORS-130Q-D-1.csv',
    'JAVA-PLATFORM-MODULE-SYSTEM-120Q-D-1.csv',
    'JAVA-STREAM-API-120Q-D-1.csv',
    'LAMBDA-BUILT-IN-FUNCTIONAL-INTERFACES-120Q-D-1.csv',
    'MANAGING-CONCURRENT-CODE-EXECUTION-120Q-D-1.csv',
    ...
    'STREAMS-AND-LAMBDA-EXPRESSIONS-120Q-D-1.csv',
    ...
    'WORKING-WITH-GENERICS-130Q-E-1.csv'
  ];
