...
export class QuestionChallengeHomeComponent {
  ...
  availableCSVFiles = [
    'ACCESSING-DATABASES-USING-JDBC-50Q-1.csv',
    'ACCESSING-DATABASES-USING-JDBC-50Q-2.csv',
    'ARRAYS-AND-COLLECTIONS-50Q.csv',
    'CONTROLLING-PROGRAM-FLOW-50Q.csv',
    'DATE-TIME-API-100Q.csv',
    'HANDLING-DATE-TIME-TEXT-NUMERIC-BOOLEAN-50Q.csv',
    'HANDLING-EXCEPTIONS-50Q.csv',
    'JAVA-OBJECT-ORIENTED-APPROACH-50Q-1.csv',
    'JAVA-OBJECT-ORIENTED-APPROACH-50Q-2.csv',
    'JAVA-OBJECT-ORIENTED-APPROACH-50Q-3.csv',
    'JAVA-OBJECT-ORIENTED-APPROACH-50Q-4.csv',
    'JAVA-OBJECT-ORIENTED-APPROACH-50Q-5.csv',
    'MANAGING-CONCURRENT-CODE-EXECUTION-50Q-1.csv',
    'MANAGING-CONCURRENT-CODE-EXECUTION-50Q-2.csv',
    'MANAGING-CONCURRENT-CODE-EXECUTION-50Q-3.csv',
    ...
    'PACKAGING-AND-DEPLOYING-PLATFORM-MODULE-SYSTEM-50Q-1.csv',
    'PACKAGING-AND-DEPLOYING-PLATFORM-MODULE-SYSTEM-50Q-2.csv',
    'PRIMATIVE-AND-WRAPPER-CLASSES-100Q.csv',
    'STREAMS-AND-LAMBDA-EXPRESSIONS-100Q-3.csv',
    'STREAMS-AND-LAMBDA-EXPRESSIONS-100Q-4.csv',
    'STREAMS-AND-LAMDA-EXPRESSIONS-50Q-1.csv',
    'STREAMS-AND-LAMDA-EXPRESSIONS-50Q-2.csv',
    'USING-JAVA-IO-API-50Q.csv'
  ];
